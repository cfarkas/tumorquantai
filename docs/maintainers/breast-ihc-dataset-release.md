...
## 1. Prepare an offline release draft
...
## 2. Package the sanitized draft locally
...
## 3. Create or resume the open Zenodo draft
...
## 4. Publish the independently authorized draft
